		...
		var i = {
			...
			define: function(t) {
				...
				t.__name = e, t.__namespace = i, t.__full = i.length > 1 ? i + "." + e : e, t.__deps = t.deps, t.__oojs = this, t.__constructor = function(t, e, i, n, o) {
					if (this.__clones && this.__clones.length > 0) for (var r = 0, a = this.__clones.length; a > r; r++) {
	...
	t.setPath("http://dup.baidustatic.com/"), t.define({
		...
		assert: function(t) {
			var e = t.placement,
				i = e.basic,
				n = e.container;
			return 1 === i.rspFormat && 2 === i.flowType && 3 === n.anchoredType
		}
	}), t.define({
		name: "config",
		...
		STATUS_FINISH: 16,
		$config: function() {
			if (i && (this.DUP_PREFIX = i), n && (this.LOADER_DEFINE_NAME = n), !this.POS_URL) {
				var t = 1e9 * Math.random();
				5e8 > t ? (this.EXP_ID = "112101", this.shieldPath()) : (this.EXP_ID = "112102", this.POS_URL = this.REQUEST_URL + "ecom?")
			}
		},
		shieldPath: function() {
			var t = this.getWord();
		...
		md5: function(t) {
			...
			return H.length < 8 && (H = R(H)), j.length < 8 && (j = R(j)), H + j
		}
	}), t.define({
		name: "requestCache",
		...
		ready: function(e, i, n) {
			...
			var r = t.proxy(this, function() {
				...
				if (t) try {
					if (this.readyFuncArray && this.readyFuncArray.length) for (var r = 0, a = this.readyFuncArray.length; a > r; r++) {
		...
		validate: function(t, e, i, n, o) {
			...
			if (!a) return r;
			for (var s = this.parsePreviewData(a), d = 1 === parseInt(s.type, 10), l = !(n.length > 0), c = !(n.length > 0), h = 0, u = n.length; u > h; h++) {
				var p = n[h];
		...
		parsePreviewData: function(t) {
			return t = decodeURIComponent(t).replace(/\/g, "&").replace(/\/g, "=").replace(/\/g, "?").replace(/\\/g, "\\"), this.lang.jsonToObj(t)
		},
...
//		},
		...
		validate: function(t) {
			var e = "true" === t.styleOpenApi.cpro_enable_hidden_float;
		...
		createContainer: function(t) {
			if (!(t.status > this.config.STATUS_CREATE)) {
				...
				t.isAsync ? "union" === t.productLine && (t.containerId = "cpro_" + t.slotId) : (document.write('<div id="' + t.containerId + '" style="position: fixed;bottom: 0px;right: 0px;"></div>'), this.dom.g(t.containerId) || this.createBackupWrapper(t)), this.setStatus(t.id, this.config.STATUS_CREATE)
			}
		},
		...
		processSlotInfo: function(t) {
			...
			if (1 === o) e.width = r, e.height = a;
				...
				var l = 0,
					c = !(!t.styleOpenApi.cpro_ftpc && "true" !== t.styleOpenApi.cpro_ftpc);
				c = 5 === o ? !0 : c;
